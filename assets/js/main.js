(function ($) {
  ...
  $documentOn.ready(function () {
    ...
    // $windowOn.on("scroll", function () {
    //   if ($(this).scrollTop() > 0) {
    //     $("#upwork-icon").addClass("show");
    //   } else {
    //     $("#upwork-icon").removeClass("show");
    //   }
    // });

    $documentOn.on("click", "#upwork-icon", function () {
      window.open("https://www.upwork.com/freelancers/~0187bd5156378af068", "_blank");
      return false;
    });
      ...
      setTimeout(function () {
        new Typed(typedEl, {
          strings: [
            ...
            '<span class="highlight">App</span> Designer',
          ],
          typeSpeed: 120,
          backSpeed: 0,
          startDelay: 0,
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const typedEl = document.querySelector(".name-text");

    if (typedEl) {
      new Typed(typedEl, {
        strings: [
          '<span class="highlight">Ehtesham.</span>',
